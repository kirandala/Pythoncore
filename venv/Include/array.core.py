...
# a1=array('d',[10,30,50,70])
# a2=array(a1.typecode,(n for n in a1))
# for x in a2:
#     print(x)
#
...
# a4=array('i',[1,2,3,4,5,6])
# print('original array is ',a4)
# a4.append(7) # 7 will be added to array a4 at the end
# b=a4.count(2) # Counts how many times 2 is available
# print('count of 2 is ',b)
# print('after added 7 ',a4)
# a4.index(3) # returs the position of 3
# a4.reverse() # array will be reversed
#
# a4.remove(5)  # 5 will be removed
# a4.pop()
# print('after removing 5 and the last element using pop and reversing the array',a4)
# print(' applying pop(0) index the removed item and returned item is:',a4.pop(0)) # it uses the index to remove the element
